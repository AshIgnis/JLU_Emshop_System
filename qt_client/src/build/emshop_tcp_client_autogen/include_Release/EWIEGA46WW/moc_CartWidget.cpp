...
QT_MOC_LITERAL(1, 11, 14), // "onCartReceived"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "data"
QT_MOC_LITERAL(4, 32, 23), // "onRemoveFromCartClicked"
QT_MOC_LITERAL(5, 56, 17) // "onCheckoutClicked"

    },
    "CartWidget\0onCartReceived\0\0data\0"
    "onRemoveFromCartClicked\0onCheckoutClicked"
};
...
void CartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onCartReceived((*reinterpret_cast< const QJsonObject(*)>(_a[1]))); break;
        case 1: _t->onRemoveFromCartClicked(); break;
        case 2: _t->onCheckoutClicked(); break;
        default: ;
        }
    }
}
