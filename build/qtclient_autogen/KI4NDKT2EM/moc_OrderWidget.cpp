...
#include "../../../qt_client/src/OrderWidget.h"
...
template <> constexpr inline auto OrderWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11OrderWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onOrdersReceived'
        QtMocHelpers::SlotData<void(const QJsonObject &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QJsonObject, 3 },
        }}),
        // Slot 'onOrderStatusUpdated'
        QtMocHelpers::SlotData<void(qint64, const QString &, const QString &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::LongLong, 5 }, { QMetaType::QString, 6 }, { QMetaType::QString, 7 },
        }}),
    };
...
void OrderWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onOrdersReceived((*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[1]))); break;
        case 1: _t->onOrderStatusUpdated((*reinterpret_cast< std::add_pointer_t<qint64>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        default: ;
        }
    }
}
