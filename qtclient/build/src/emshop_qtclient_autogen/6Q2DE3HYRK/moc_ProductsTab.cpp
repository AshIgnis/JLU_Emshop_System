...
template <> constexpr inline auto ProductsTab::qt_create_metaobjectdata<qt_meta_tag_ZN11ProductsTabE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'applyStockChanges'
        QtMocHelpers::SlotData<void(const QJsonArray &)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ProductsTab::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->applyStockChanges((*reinterpret_cast< std::add_pointer_t<QJsonArray>>(_a[1]))); break;
        case 5: _t->executeSearch(); break;
        case 6: _t->addSelectedToCart(); break;
        case 7: _t->updateDetailView(); break;
        default: ;
        }
    }
